export default {
    ...
    ru: {
        ...
        notFound:
            'Упс! Кажется, вы не зарегистрировались на нашем сайте :(\nЗарегистрируйтесь на сайте baliving.ru и возвращайтесь!',
        expired:
            'Упс! Кажется, срок действия подписки истек:(\nПродлите тариф на сайте baliving.ru и возвращайтесь!',
        ...
        minPrice:
            'Укажите нижнюю границу стоимости за месяц в долларах.\n\nВнимание!\nВведите только цифры.',
    ...
    en: {
        ...
        chooseAreas:
            'Select the areas where you are considering housing. Choose a few of your favorites',
        numberOfBeds:
            'Enter the number of bedrooms. Pick a few of your favorites',
        minPrice:
            'Specify the lower limit of the price per month in dollars.\n\nWarning!\nEnter numbers only.',
